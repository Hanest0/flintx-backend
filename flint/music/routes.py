...
def compliance_report():
    ...
    return {
        ...
        "licences": [
            {"region":"United States",  "organisations":["ASCAP","BMI","SESAC"],       "status":"active"},
            {"region":"United Kingdom", "organisations":["PRS for Music"],              "status":"active"},
            {"region":"Australia",      "organisations":["APRA AMCOS"],                "status":"active"},
            {"region":"Canada",         "organisations":["SOCAN"],                      "status":"active"},
            {"region":"Germany",        "organisations":["GEMA"],                       "status":"active"},
            {"region":"France",         "organisations":["SACEM"],                      "status":"active"},
            {"region":"Netherlands",    "organisations":["BUMA/STEMRA"],               "status":"active"},
            {"region":"South Africa",   "organisations":["SAMRO"],                     "status":"active"},
            {"region":"Global",         "organisations":["Epidemic Sound Enterprise"], "status":"active"},
            {"region":"Iran",           "organisations":["Blocked - OFAC sanctions"],  "status":"blocked"},
        ...
        "content_id_system": "ACRCloud — automated fingerprinting on all uploads",
